...
function Sidebar() {
  const linkClass = ({ isActive }) =>
    `flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 ${
      isActive 
        ...
        : 'text-gray-400 hover:text-white hover:bg-[#252250]'
    }`
  ...
  return (
    <aside className="w-72 min-h-screen bg-[#0f0d24] flex flex-col p-4">
      ...
      {/* Navegación */}
      <nav className="flex flex-col gap-2" style={{ fontFamily: 'Syncopate, sans-serif' }}>
      ...
      <div className="border-t border-gray-700 pt-4 mt-4">
        <div className="flex items-center gap-3 px-4 py-2 text-gray-400">
          ...
          <span className="text-sm" style={{ fontFamily: 'Syncopate, sans-serif' }}>AJUSTES</span>
        </div>
      </div>
    </aside>
  )
